...
class LedCalloutHandler
{
    public:
        ...
        LedCalloutHandler(const LedCalloutCreateHandler&) = delete;
        LedCalloutHandler& operator=(const LedCalloutCreateHandler&) = delete;
        LedCalloutHandler(LedCalloutCreateHandler&&) = default;
        LedCalloutHandler& operator=(LedCalloutCreateHandler&&) = default;
