...
struct BadResponseError : public sdbusplus::exception_t
{
    static constexpr auto errName = "xyz.openbmc_project.Led.Mapper.BadResponseError";
    static constexpr auto errDesc = "Failed to get response from the method.";
    static constexpr auto L = level::INFO;
    using METHOD_NAME = _BadResponseError::METHOD_NAME;
    using PATH = _BadResponseError::PATH;
    using INTERFACE = _BadResponseError::INTERFACE;
    using metadata_types = std::tuple<METHOD_NAME, PATH, INTERFACE>;
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Led::Mapper::Error::BadResponseError>
{
    using type = xyz::openbmc_project::Led::Mapper::BadResponseError;
};
