 ...
 *  @brief Implementation of LED handling during the change of the Function
 *         property of the OperationalStatus interface
 *  @details This implements methods for watching for a OperationalStatus in the
 *           Inventory D-Bus object being logged to assert the corresponding LED
 */
class OperStatusSingal
{
  public:
