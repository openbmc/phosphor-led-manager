                       ...
                       const std::string& path)
{
    ...
    {
        elog<xyz::openbmc_project::Led::Mapper::BadResponseError>(
            xyz::openbmc_project::Led::Mapper::BadResponseError::METHOD_NAME("GetObject"),
            xyz::openbmc_project::Led::Mapper::BadResponseError::PATH(path.c_str()),
            xyz::openbmc_project::Led::Mapper::BadResponseError::INTERFACE(
                OBJMGR_IFACE));
    }
            ...
            const bool assert)
{
    ...
    catch (xyz::openbmc_project::Led::Mapper::BadResponseError& e)
    {
        commit<xyz::openbmc_project::Led::Mapper::BadResponseError>();
        return;
    }
