                            ...
                            const std::string& healthStatus)
{
    ...
    {
        setPhysicalLed(dbusNames["SystemLed"] + std::to_string(host), "Off", 0,
                       0);
        setPhysicalLed(dbusNames["PowerLed"] + std::to_string(host), "Blink",
                       90, 900);
    }
    else if ((powerStatus == "On") && (healthStatus == "Bad"))
    {
        setPhysicalLed(dbusNames["PowerLed"] + std::to_string(host), "On", 0,
                       0);

        setPhysicalLed(dbusNames["SystemLed"] + std::to_string(host), "Blink",
                       90, 900);
    }
