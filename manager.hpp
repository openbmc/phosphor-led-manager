...
class Manager
{
  public:
    ...
    Manager(sdbusplus::bus::bus& bus, const LedLayout& ledLayout,
        ...
        ledMap(ledLayout),
        bus(bus), dBusHandler(dBusHandler)
    {
        // Nothing here
    }
    ...
    /** @brief Get the physical LEDs by the object path and property name of
     *         D-Bus
     *
     ...
     */
    PropertyValue getPhysicalLED(const std::string& objectPath,
