                            ...
                            group& ledsAssert, group& ledsDeAssert)
{
    ...
    // Find difference between CurrentVirtual and Desired to identify
    // which LEDs are de-asserted
    group transient {};
    std::set_difference(currentVirtual.begin(), currentVirtual.end(),
    ...
    currentVirtual = std::move(desiredState);
