                        ...
                        group& ledsUpdate)
{
    ...
    // Get a map of physical LED dbus paths to their Service providers
    // since its costly to make a seperate call for each and every LED
    phyLeds.clear();

    // This will populate a map
    getServiceNames();
