...
/** Called when the group's property is read
...
/** Called when the group's asserted state is updated
 *  Signature as needed by sd_bus */
...
/** Users having to assert a group will just turn this property to 1
    ...
    iv_bus(sdbusplus::bus::new_system())
{
    ...
    // Once done, claim the bus and systemd will consider this service started
